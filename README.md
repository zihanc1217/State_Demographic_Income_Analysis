...
- The distribution remains largely balanced and not heavily distorted by extreme outliers.
...
### 1. Income Distribution Across States
This histogram illustrates the distribution of median household incomes across all U.S. states from 2021 to 2023. It highlights right skewness and clear separation between high-income and low-income states.

![Income Distribution](images/income_distribution.png)

### 2. Correlation Between Demographic and Economic Features
This heatmap visualizes the correlations between demographic variables (age structure, sex ratio) and economic indicators such as median income and income growth rates. It helps identify patterns and relationships useful for deeper statistical analysis.

![Correlation Heatmap](images/correlation_heatmap.png)

### 3. Income Growth Rate
To analyze year-over-year economic changes at the state level, an income growth rate feature was engineered from the raw median household income data. This metric captures the relative change in income between consecutive years and serves as an indicator of short-term economic performance.

![Income Growth](images/income_growth_rate.png)
...
## 9. Technical Stacks and Skills Demonstrated
### Programming:
   - Python
   - Numpy, Pandas
   - matplotlib, seaborn
...
- Analysis focuses on cross-sectional comparisons due to limited time span.
 ...
 For full analysis, detailed visualizations, and complete narrative interpretation, please refer to the final report in `outputs/Report.ipynb`.
